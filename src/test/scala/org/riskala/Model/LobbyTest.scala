...
class LobbyTest extends AnyWordSpec with BeforeAndAfterAll {
  ...
  "Subscribe to Lobby" should {
    "give Lobby info" in {
      ...
      probeSub.expectMessage(LobbyInfoMessage(LobbyInfo(List.empty[RoomNameInfo],List.empty[String],List.empty[String])))
  ...
  "Creation of a Room in Lobby" should {
    "create the Room and give Lobby info to subs" in {
      ...
      probeCreate.expectMessage(LobbyInfoMessage(LobbyInfo(List.empty[RoomNameInfo],List.empty[String],List.empty[String])))
      probeCreate2.expectMessage(LobbyInfoMessage(LobbyInfo(List.empty[RoomNameInfo],List.empty[String],List.empty[String])))
      lobby ! CreateRoom(probeCreate.ref, RoomInfo(RoomBasicInfo("Europa", 0, 4), ""))
      probeCreate2.expectMessage(LobbyInfoMessage(LobbyInfo(List(RoomNameInfo("Europa","0/4")),List.empty[String],List.empty[String])))
    }
  }
  ...
  "Join a Room from Lobby" should {
    "remove from Lobby and update info" in {
      ...
      val emptyLobby = LobbyInfo(List.empty[RoomNameInfo],List.empty[String],List.empty[String])
      val nonEmptyLobby = LobbyInfo(List(RoomNameInfo("Usa","0/6")),List.empty[String],List.empty[String])
  ...
  "StartGame to Lobby" should {
    "update Lobby info" in {
      ...
      probeSub.expectMessage(LobbyInfoMessage(LobbyInfo(List.empty[RoomNameInfo],List("Europe"),List.empty[String])))
    }
  }
  ...
  "EndGame to Lobby" should {
    "update Lobby info" in {
      ...
      val emptyLobby = LobbyInfo(List.empty[RoomNameInfo],List.empty[String],List.empty[String])
      val nonEmptyLobby = LobbyInfo(List.empty[RoomNameInfo],List.empty[String],List("Europa"))
      lobby ! Subscribe(probeSub.ref)
  ...
  "UpdateRoom to Lobby" should {
    "update the Room info and notify subs" in {
      ...
      val emptyLobby = LobbyInfo(List.empty[RoomNameInfo],List.empty[String],List.empty[String])
      val nonEmptyLobby = LobbyInfo(List(RoomNameInfo("Europa","0/4")),List.empty[String],List.empty[String])
  ...
  "EmptyRoom to Lobby" should {
    "remove the Room info and notify subs" in {
      ...
      probeEmpty.expectMessage(RoomInfoMessage(info))
